...
const ProfileBlogsCard = () => {
  return (
    <div>
      <div className="md:w-[300px] w-[300px]  flex flex-col space-y-5 pb-[60px] shadow-sm">
        <Image src="/BlogImage.svg" width={300} height={150} alt="Blog Image" />
        <div className="pt-2 px-[10px]">
          ...
          <div className="flex flex-row pt-2">
            ...
            <p className="text-[#6262a0] text-[12px] px-2">by</p>
          ...
          <div className="flex flex-row pt-2 space-x-6  pb-[12px]">
