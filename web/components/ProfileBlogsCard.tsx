...
const ProfileBlogsCard = () => {
  return (
    <div>
      <div className="md:w-[250px] w-[300px]  flex flex-col space-y-5 pb-[60px]">
        ...
        <div className="pt-2">
          ...
          <div className="flex flex-row pt-2 space-x-6 pl-5">
            <button className="px-[12px] py-[6px] bg-[#F5F5F5] rounded-md text-[8px] text-[#8E8E8E]">
              UI/UX
            </button>
            <button className="px-[12px] py-[6px] bg-[#F5F5F5] rounded-md text-[8px] text-[#8E8E8E]">
              Development
